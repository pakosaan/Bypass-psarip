...
def psa_bypasser(psa_url):
    ...
    soup = BeautifulSoup(r.text, "html.parser").find_all('noindex')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='PSA Bypasser')
    parser.add_argument('urls', metavar='URL', type=str, nargs='+', help='List of URLs to bypass')
